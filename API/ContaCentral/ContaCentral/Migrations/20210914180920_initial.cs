        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deposito_Carteira_CarteiraId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Saque_Carteira_CarteiraId",
                        column: x => x.CarteiraId,
                        principalTable: "Carteira",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transferencia_Carteira_FromCarteiraId",
                        column: x => x.FromCarteiraId,
                        principalTable: "Carteira",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transferencia_Carteira_ToCarteiraId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposito_CarteiraId",
                table: "Deposito",
                column: "CarteiraId");

            migrationBuilder.CreateIndex(
                name: "IX_Saque_CarteiraId",
                table: "Saque",
                column: "CarteiraId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transferencia_FromCarteiraId",
                table: "Transferencia",
                column: "FromCarteiraId");

            migrationBuilder.CreateIndex(
                name: "IX_Transferencia_ToCarteiraId",
                table: "Transferencia",
                column: "ToCarteiraId");
        }
